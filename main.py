                    ...
                    if response:
                        if inPuTMsG.startswith(("/5")):
                            try:
                                ...
                                await asyncio.sleep(0.05)  # SPEED: 0.5 -> 0.05
                                await SEndPacKeT(whisper_writer , online_writer , 'OnLine' , C)
                                V = await SEnd_InV(5 , uid , key , iv,region)
                                await asyncio.sleep(0.05)  # SPEED: 0.5 -> 0.05
                                await SEndPacKeT(whisper_writer , online_writer , 'OnLine' , V)
                                E = await ExiT(None , key , iv)
                                await asyncio.sleep(0.5)   # SPEED: 3 -> 0.5 (FAST LEAVE)
                            ...
                            try:
                                ...
                                if not s:
                                    try:
                                        ...
                                        # 🚀 Super Fast Emote Loop - ULTRA SPEED
                                        for i in range(200):  # repeat count
                                            ...
                                            await asyncio.sleep(0.02)  # ⚡ ULTRA-FAST: 0.08 -> 0.02
                            ...
                            try:
                                ...
                                if not s:
                                    try:
                                        ...
                                        await asyncio.sleep(0.05)  # SPEED: Added fast delay between emotes
...
async def perform_emote(team_code: str, uids: list, emote_id: int):
    ...
    try:
        ...
        await asyncio.sleep(0.1)  # SPEED: 0.5 -> 0.1
        ...
        for uid_str in uids:
            ...
            await asyncio.sleep(0.03)  # SPEED: 0.1 -> 0.03
